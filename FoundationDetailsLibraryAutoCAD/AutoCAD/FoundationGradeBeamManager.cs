...
{
    public class FoundationGradeBeamManager
    {
        ...
        public const string XrecordKey = "FD_GRADEBEAM";
        ...
        /// </summary>
        public static bool TrySetGradeBeam(ObjectId id, out string error)
        {
            error = "";
            ...
            try
            {
                ...
                using (var tr = db.TransactionManager.StartTransaction())
                {
                    ...
                    Polyline cleaned = FixGradeBeam(pl);
        ...
        private static Polyline FixGradeBeam(Polyline pl)
        {
            if (pl == null) return null;

            // Fix default arrangement of the grade beams -- i.e. left is label end, top is label end, and so forth.
            return pl;
    
        }

        /// <summary>
        /// Gets the selected grade beam.
        /// </summary>
        public static bool TryGetGradeBeam(out Polyline pl)
        {
            pl = null;
            var doc = Application.DocumentManager.MdiActiveDocument;
            if (doc == null) return false;

            if (!TryGetGradeBeamId(out ObjectId id) || id.IsNull) return false;
        ...
        /// </summary>
        public static bool TryGetGradeBeamId(out ObjectId id)
        {
            id = ObjectId.Null;
            var doc = Application.DocumentManager.MdiActiveDocument;
            if (doc == null) return false;
            ...
            ObjectId xId = ReadStoredGradeBeamFromXrecord();
        ...
        /// </summary>
        public static void HighlightGradeBeam()
        {
            if (!TryGetGradeBeam(out Polyline pl)) return;
            var doc = Application.DocumentManager.MdiActiveDocument;
        ...
        /// </summary>
        public static void ZoomToGradeBeam()
        {
            if (!TryGetGradeBeam(out Polyline pl)) return;
            var doc = Application.DocumentManager.MdiActiveDocument;
            var ed = doc.Editor;
        ...
        private static void QueueStoreXrecord(ObjectId id)
        {
            ...
            doc.SendStringToExecute("_.FD_SaveGradeBeam ", true, false, true);
        }

        /// <summary>
        /// Command method that runs in AutoCAD command context to write the Xrecord safely.
        /// </summary>
        [CommandMethod("FD_SaveGradeBeam")]
        public static void FD_SaveGradeBeam()
        {
            var doc = Application.DocumentManager.MdiActiveDocument;
            if (doc == null) return;
        ...
        /// </summary>
        private static ObjectId ReadStoredGradeBeamFromXrecord()
        {
            var doc = Application.DocumentManager.MdiActiveDocument;
